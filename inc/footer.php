...
<div class="container p-4 pb-0">
    ...
    <section class="mb-4">
        ...
        <a class="btn btn-primary btn-floating m-1" style="background-color: #dd4b39;" href="#!" role="button"><i class="fa-brands fa-google"></i></a>
        ...
        <a class="btn btn-primary btn-floating m-1" style="background-color: #0082ca;" href="#!" role="button"><i class="fa-brands fa-tiktok"></i></a>
...
<div class="text-center p-3 bg-dark">
    © 2024 Copyright:
    <a class="text-white" href="#">Đặng Đình Bảo Long</a>
</div>
</footer>
